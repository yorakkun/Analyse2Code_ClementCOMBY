...
public class ShuttleApplication extends DaggerApplication {
    ...
    public void onCreate() {
        ...
        if (BuildConfig.DEBUG) {
            // Only install RxDogTag in debug builds
            RxDogTag.install();
        }
        ...
        // Crashlytics setup should be done for all builds, but can be disabled in debug builds
    ...
    public String getVersion() {
        try {
            ...
            LogUtils.logException(TAG, "Failed to get version of package", ignored);
        }
        return "unknown";
    }
    ...
    private Completable cleanMostPlayedPlaylist() {
        ...
        return Completable.fromAction(() -> {
            ...
            try {
                ...
                Log.e("ContentResolverDelete", "IllegalArgumentException encountered.", e);
            }
        });
    }
